...
/**
 * Core entity of the system. The appointmentNumber is the unique business key
 * generated by the Singleton AppointmentNumberGenerator (pattern/singleton),
 * not the database primary key, matching the brief's requirement that each
 * patient visit is assigned a unique appointment number that staff search by.
 */
@Entity
